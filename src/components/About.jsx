  ...
  const experiences = [
    {
      ...
      description: "Atendimento técnico em infraestrutura de redes e servidores, suporte e manutenção de hardware/software."
    },
    {
      title: "Vice-Diretor de Comunicação",
      company: "CAECOMP - UEMG",
      period: "Jul 2025 - Atualmente",
      description: "Criação de materiais visuais e planejamento estratégico de comunicação para o Centro Acadêmico."
    },
    {
      ...
      <div className="about-container">
        <div className="about-content">
          ...
          <p className="about-text">
            ...
            conhecimentos em bancos de dados MySQL e PostgreSQL. Atualmente, estou envolvido em
